...
class App(QDialog):
    def __init__(self):
        ...
        self.net = cv2.dnn.readNetFromDarknet(r"C:\Users\syndi\Downloads\Garud-Drishti-main\Garud-Drishti-main\yolov3.cfg", r"C:\Users\syndi\Downloads\Garud-Drishti-main\Garud-Drishti-main\yolov3.weights")
